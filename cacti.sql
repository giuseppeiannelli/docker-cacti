...
CREATE TABLE host (
  ...
  status_fail_date datetime NOT NULL default '1970-01-01 00:00:00',
  status_rec_date datetime NOT NULL default '1970-01-01 00:00:00',
...
INSERT INTO `host` VALUES (1, 8, 'Localhost', '127.0.0.1', '', 'public', 0, '', '', 'MD5', '', 'DES', '', 161, 500, 3, 2, 23, 400, 1, 10, 1, '', 0, 0, '1970-01-01 00:00:00', '1970-01-01 00:00:00', '', 9.99999, 0.00000, 0.00000, 0.00000, 0, 0, 100.00000);
...
INSERT INTO `settings` VALUES ('path_spine','/usr/local/spine/bin/spine'),('rrdtool_version','rrd-1.5.x'),('realtime_cache_path','/usr/share/nginx/cacti/cache');
